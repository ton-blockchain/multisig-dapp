  ...
  return (
    <div id="modal" className="hidden modal flex flex-col justify-center w-screen h-screen">
        <div id="modal-content" className="flex flex-col gap-4 md:gap-8 bg-white-mode1 w-[90%] md:w-[45%] h-auto ml-auto mr-auto pb-[2rem]">
            ...
            <input type="text" name="serach" className="ml-auto mr-auto good-input w-[80%] max-w-full h-[4rem] rounded-md font-usual font-semibold mm:text-[0.82rem] md:text-[2rem]" placeholder="Recipient"/>
            <input type="text" name="serach" className="ml-auto mr-auto good-input w-[80%] max-w-full h-[4rem] rounded-md font-usual font-semibold mm:text-[0.82rem] md:text-[2rem]" placeholder="Amount"/>
            <input type="text" name="serach" className="ml-auto mr-auto good-input w-[80%] max-w-full h-[4rem] rounded-md font-usual font-semibold mm:text-[0.82rem] md:text-[2rem]" placeholder="Body or Base64 BOC"/>
