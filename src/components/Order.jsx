...
const Order = () => {
    ...
    function AddSmth() {
        ...
        document.querySelector('.list-orders').insertAdjacentHTML('beforeend', `<div id="k${id}" class="grid border-2 dark:border-[rgba(16, 22, 31, 1)] ml-[2rem] mr-[2rem] grid-cols-2">
  ...
  return (
    <div id="modal" className="hidden modal flex flex-col justify-center w-screen h-screen">
        <div id="modal-content" className="dark:text-white flex flex-col gap-4 md:gap-8 bg-white-mode1 dark:bg-black-mode1 w-[90%] md:w-[45%] h-auto ml-auto mr-auto pb-[2rem] rounded-lg">
            <h1 className="font-semibold dark:text-white text-[1.3rem] md:text-[2rem] pl-[1.5rem] pt-[0.3rem] pb-[0.3rem] font-usual ml-auto mr-auto">Create new order</h1>
            <input type="text" name="serach" className="elem1 dark:text-white pl-[1rem] ml-auto mr-auto good-input dark:bg-[rgb(30,31,34)] w-[80%] max-w-full h-[3.5rem] rounded-md font-usual font-semibold mm:text-[0.82rem] md:text-[1.8rem]" placeholder="Recipient"/>
            <input type="text" name="serach" className="elem2 dark:text-white pl-[1rem] ml-auto mr-auto good-input dark:bg-[rgb(30,31,34)] w-[80%] max-w-full h-[3.5rem] rounded-md font-usual font-semibold mm:text-[0.82rem] md:text-[1.8rem]" placeholder="Amount"/>
            <input type="text" name="serach" className="elem3 dark:text-white pl-[1rem] ml-auto mr-auto good-input dark:bg-[rgb(30,31,34)] w-[80%] max-w-full h-[3.5rem] rounded-md font-usual font-semibold mm:text-[0.82rem] md:text-[1.8rem]" placeholder="Text comment or base64 raw body"/>
