    ...
    <div id="modal" className="hidden modal flex flex-col justify-center w-screen h-screen">
        <div id="modal-content" className="flex flex-col gap-4 md:gap-8 bg-white-mode1 w-[90%] md:w-[45%] h-auto ml-auto mr-auto pb-[2rem]">
            ...
            <div className="flex gap-2">
                <div onClick={AddSmth} className="cursor-pointer w-full mt-auto mb-auto text-[1.2rem] lg:text-[2.3rem] font-[550] flex flex-col justify-center h-[2.2rem] lg:h-[3rem] bg-gray-400 text-center align-middle rounded-lg ml-[1.3rem]">Add</div>
                <div onClick={SaveDisk} className="cursor-pointer w-full mt-auto mb-auto text-[1.2rem] lg:text-[2.3rem] font-[550] flex flex-col justify-center h-[2.2rem] lg:h-[3rem] bg-button-blue text-center align-middle rounded-lg mr-[1.3rem]">Save to disk</div>
            </div>
            <div className="flex">
                <div onClick={SignSend} className="cursor-pointer w-full text-[1.5rem] lg:text-[2.3rem] font-[550] flex flex-col justify-center h-[2.2rem] lg:h-[3rem] bg-button-blue text-center align-middle rounded-lg ml-[1.3rem] mr-[1.3rem]">Sign & send</div>
            </div>
