        ...
        <div className="w-[80%] lap:w-[62%] desktop:w-[54%] min-h-max mt-[4rem] bg-white-mode1 dark:bg-black-mode1 ml-auto mr-auto rounded-lg pb-[2rem]">
            ...
            <form>
                <div className="flex justify-around text-center flex-wrap mt-[1.3rem]">
                    <input type="text" name="serach" className="dark:text-white dark:bg-[rgb(30,31,34)] mb-[1.5rem] pl-[1rem] good-input w-[9rem] 2xl:w-[17rem] rounded-md font-usual font-semibold text-[100%] md:text-[2rem] 2xl:text-[1.75rem]" placeholder="Workchain ID"/>
                    <input type="text" name="serach" className="dark:text-white dark:bg-[rgb(30,31,34)] mb-[1.5rem] pl-[1rem] good-input w-[9rem] 2xl:w-[17rem] rounded-md font-usual font-semibold text-[100%] md:text-[2rem] 2xl:text-[1.75rem]" placeholder="Wallet ID"/>
                    <input type="text" name="serach" className="dark:text-white dark:bg-[rgb(30,31,34)] mb-[1.5rem] pl-[1rem] good-input w-[9rem] 2xl:w-[17rem] rounded-md font-usual font-semibold text-[100%] md:text-[2rem] 2xl:text-[1.75rem]" placeholder="K-value"/>
                </div>
                <div className="flex sm:ml-[1rem] md:ml-[2rem] lg:ml-[4rem]">
                    ...
                    <img onClick={AddNew} src={localStorage.getItem('darkmode') == 1 ? more2 : more} alt="" className="more cursor-pointer h-[24px] md:h-[38px] ml-[1rem] mr-[0.4rem] mt-auto mb-auto"/>
                </div>
                <div className="keys_list flex flex-col gap-6 sm:ml-[1rem] md:ml-[2rem] lg:ml-[4rem] mb-[2rem] mt-[1rem]">
                    <div id='1' className="key flex gap-2 md:gap-5">
                        ...
                        <img id='img1' onClick={() => DeleteNew(1)} src={localStorage.getItem('darkmode') == 1? cancel2 : cancel} alt="" className="cancel cursor-pointer keyimg h-[1.4rem] md:h-[2.6rem] mb-auto mt-auto"/>
                    </div>
                </div>
