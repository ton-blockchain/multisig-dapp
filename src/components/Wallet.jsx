            ...
            <div className="flex justify-around text-center flex-wrap">
                <div className="pt-[1.3rem] flex flex-col text-center mt-auto mb-auto ml-[0.5rem] mr-[0.5rem] w-[8rem] lg:w-[15rem]">
                    ...
                    <div className="flex ml-auto mr-auto">
                        ...
                        <img src={localStorage.getItem('darkmode') == 1 ? balance2 : balance} alt="" className="balance h-[20px] lg:h-[26px] ml-[5px] mt-auto mb-auto" />
                    </div>
                </div>
            ...
            <div className="flex justify-around mt-[2rem] flex-wrap ml-[0.5rem] mr-[0.5rem]">
                ...
                <div className="flex flex-col mt-[1rem] mb-[3rem] gap-3">
                    ...
                    <div class="input__wrapper">
                        ...
                        <span className="input__file-icon-wrapper mt-auto mb-auto"><img class="input__file-icon" src={localStorage.getItem('darkmode') == 1 ? download2 : download} alt="Выбрать файл" className="download mt-auto mb-auto w-[40px] md:w-[50px]" /></span>
