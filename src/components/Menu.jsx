    ...
    return (
      <header className="static bg-white-mode1 dark:bg-black-mode1  flex justify-between h-[5rem] 2xl:h-[6rem] align-middle">
        <div className="flex align-middle gap-1">
          ...
          <div className="hidden testnet mt-auto mb-auto sm:ml-[0.2rem] md:ml-[2rem] max-w-max md:text-[1.2rem] font-[550] flex flex-col justify-center h-[1.5rem] md:h-[2.2rem] bg-button-blue text-center align-middle rounded-full text-white pl-[0.8rem] pr-[0.8rem] md:pl-[1.2rem] md:pr-[1.2rem]">Testnet</div>
        ...
        <div className="flex align-middle mr-[1rem]">
          ...
          <img onClick={Buuton_click} src={settings} alt="" className="icon_set cursor-pointer h-[40px] 2xl:h-[55px] mt-auto mb-auto" />
        </div>
        <div className="hidden settings flex flex-col settings h-[7rem] bg-[#D5D7D8] dark:bg-[rgb(56,58,58)] fixed z-1 right-5 top-[5rem] pl-[1rem] pr-[1rem] rounded-lg">
          ...
          <div className="flex gap-4 mt-auto mb-auto">
            <h1 className="font-mono font-[550] text-[1.5rem] lg:text-[1.7rem]">Dark mode</h1>
            <Toggle
                label="tesnet mode"
                toggled={false}
                onClick={DarkMode}
