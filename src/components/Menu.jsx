    ...
    return (
      <header className="static bg-white-mode1 flex justify-between h-[5rem] 2xl:h-[6rem] align-middle">
        <div className="flex align-middle gap-1">
          <img onClick={logoBack} src={ton} alt="" className="cursor-pointer h-[50px] 2xl:h-[70px] mt-auto mb-auto ml-[1rem]" />
        ...
        <div className="flex align-middle mr-[1rem]">
          <h1 onClick={Buuton_new} className="cursor-pointer Buuton 2xl:text-[1.7rem] text-usual text-wallet font-semibold mt-auto mb-auto mr-[1.5rem] 2xl:mr-[4.5rem]">New wallet</h1>
          <img onClick={Buuton_click} src={settings} alt="" className="cursor-pointer h-[50px] 2xl:h-[70px] mt-auto mb-auto" />
        </div>
