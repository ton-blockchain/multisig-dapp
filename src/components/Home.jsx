import { ton, settings, multisigwallet, protection, protection2 } from "../assets";
...
const Home = () => {
  ...
  return (
    <div className={`home grow flex flex-col justify-center pb-[7rem] ${window.location.pathname != '/create' && window.location.pathname.slice(0,7) != '/wallet' ? "" : "hidden"}`}>
      ...
      <img src={localStorage.getItem('darkmode') == 1 ? protection2 : protection} className="protection w-[20rem] md:w-[53vw] ml-auto mr-auto mb-[3rem]" alt="" />
