  ...
  return (
    <div className="home grow flex flex-col justify-center pb-[7rem]">
      ...
      <div className="inputWithIcon w-[90%] md:w-[35rem] lg:w-[45rem] 2xl:w-[55rem] ml-auto mr-auto">
        ...
        <input id="wallet" onChange={handleSubmit2} type="text" name="serach" className="homeInput good-input w-full max-w-full h-[4rem] rounded-md font-usual font-semibold mm:text-[0.82rem] md:text-[1.9rem]" placeholder="Enter a multi-sig wallet address to start"/>
